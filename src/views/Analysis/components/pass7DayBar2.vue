  ...
  data () {
    return {
      ...
      weekData: {
        ...
        xAxisData: [],
        seriesData: [
          { name: '加油区全景', data: [], type: 'bar',label: { normal: { show: true,}}},
          { name: '加油区', data: [], type: 'bar',label: { normal: { show: true,} }},
          { name: '收银台', data: [], type: 'bar',label: { normal: { show: true,} }},
          { name: '保险柜', data: [], type: 'bar',label: { normal: { show: true,} }},
          { name: '卸油口', data: [], type: 'bar',label: { normal: { show: true,} }}
        ]
      }
    }
  },
